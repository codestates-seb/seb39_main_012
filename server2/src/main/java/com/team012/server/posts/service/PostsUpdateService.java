...
public class PostsUpdateService {
    ...
    public PostsResponseDto updatePostResponse(PostsUpdateDto request, List<MultipartFile> files, Long usersId) {
        ...
        return convertToPostsResponseDto.createToDto(companyId, response, roomList, hashTags,serviceTags);
    }
}
